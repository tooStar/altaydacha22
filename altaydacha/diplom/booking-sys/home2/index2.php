...
function build_calendar($month, $year) {
    ...
    $stmt = $mysqli->prepare("SELECT * FROM room2 WHERE MONTH(date) = ? AND YEAR(date) = ?");
    ...
    while ($currentDay <= $numberDays) {
        ...
        elseif(in_array($date, $bookings)){
            ...
            $calendar.="<td class='$today'><h4>$currentDay</h4> <a href='book2.php?date=".$date."' class='btn btn-success btn-xs'>Забронировать</a>";
        }
...
<body>
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1>Бронирование для Дома №2, на:</h1>
                <?php
